...
class _ScannerAppBridge:
    ...
    def db(self):
        ...
        # property the desktop bridge had no ``db`` attribute at all, so
        # every production DetailScraper construction passed db=None and
        # detached whatever database a real caller had already wired up.
