    ...
    try:
        ...
        if stragglers:
            logger.warning(
                ...
                "thread(s): %s — abandoning them. Teardown is bounded; "
                "PROCESS EXIT IS NOT, because a straggler's own workers "
                "(executor threads, subprocesses) are not tracked here and "
                "can still hold the interpreter open.",
