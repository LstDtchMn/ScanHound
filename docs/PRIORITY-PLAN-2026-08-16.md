...
> **SCOPE CORRECTED 2026-08-16.** This file originally mixed ScanHound work with
> homelab infrastructure (Frigate, Immich, Procare, VLANs, UniFi, the MedSpa site,
> TL-* backlog items). That was a scoping error in how the audit was commissioned:
> the request was about recent CODING work, and the sweep was widened to the whole
> house. **25 non-ScanHound items have been removed from this file.** They are not
> lost -- they live in `C:\DockerData\infra-ops\BACKLOG.md`, which is their
> authoritative home and already tracks them as TL-numbers.
>
> Everything below is ScanHound only.
