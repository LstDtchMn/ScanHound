...
head:   46be010   R22-1/3/4 + R21-4 consumer + mapping corrections
        bae6860   R22-2 + R22-5: stop two more silent losses of evidence
        f982f5d   Round 22 peer-review package
        c4d9dc0   -- the head your Round-22 review read
```

The enclosed patch is `c4d9dc0..46be010`, so it is exactly what changed since
the code you reviewed.

`46be010` is **not** an ancestor of `origin/main`
